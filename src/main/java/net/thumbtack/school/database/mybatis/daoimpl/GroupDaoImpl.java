...
public class GroupDaoImpl extends DaoImplBase implements GroupDao {
    ...
    public Group insert(School school, Group group) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't insert Group {}.\n{}", group, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public Group update(Group group) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't update Group {}.\n{}", group, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public List<Group> getAll() {
        ...
        try (SqlSession sqlSession = getSession()) {
            ...
            LOGGER.info("Can't get all Groups.\n{}", ex);
            throw ex;
        }
    }
    ...
    public void delete(Group group) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't delete Group {}.\n{}", group, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public Trainee moveTraineeToGroup(Group group, Trainee trainee) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't move Trainee {} to Group {}.\n{}", trainee, group, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public void addSubjectToGroup(Group group, Subject subject) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't add Subject {} to Group {}.\n{}", subject, group, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
