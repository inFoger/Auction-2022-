...
public class SubjectDaoImpl extends DaoImplBase implements SubjectDao {
    ...
    public Subject insert(Subject subject) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't insert Subject {}.\n{}", subject, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public Subject getById(int id) {
        ...
        try (SqlSession sqlSession = getSession()) {
            ...
            LOGGER.info("Can't get Subject by id {}.\n{}", id, ex);
            throw ex;
        }
    }
    ...
    public Subject update(Subject subject) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't update Subject {}.\n{}", subject, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public void delete(Subject subject) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't delete Subject {}.\n{}", subject, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public void deleteAll() {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't delete all Subjects.\n{}", ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
