...
public class SchoolDaoImpl extends DaoImplBase implements SchoolDao {
    ...
    public School insert(School school) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't insert School {}.\n{}", school, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public School getById(int id) {
        ...
        try (SqlSession sqlSession = getSession()) {
            ...
            LOGGER.info("Can't get School by id {}.\n{}", id, ex);
            throw ex;
        }
    }
    ...
    public List<School> getAllLazy() {
        ...
        try (SqlSession sqlSession = getSession()) {
            ...
            LOGGER.info("Can't get all Schools lazy.\n{}", ex);
            throw ex;
        }
    }
    ...
    public List<School> getAllUsingJoin() {
        ...
        try (SqlSession sqlSession = getSession()) {
            ...
            LOGGER.info("Can't get all Schools using join.\n{}", ex);
            throw ex;
        }
    }
    ...
    public void update(School school) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't update School {}.\n{}", school, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public void delete(School school) {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't delete School {}.\n{}", school, ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
    ...
    public void deleteAll() {
        ...
        try (SqlSession sqlSession = getSession()) {
            try {
                ...
                LOGGER.info("Can't delete all Schools.\n{}", ex);
                sqlSession.rollback();
                throw ex;
            }
            sqlSession.commit();
