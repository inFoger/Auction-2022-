...
public interface SchoolMapper {
    ...
    @Results({
            ...
            @Result(property = "groups", column = "id", javaType = List.class,
                    many = @Many(select = "net.thumbtack.school.database.mybatis.mappers.GroupMapper.getBySchoolId", fetchType = FetchType.LAZY))
    })
    ...
    @Insert("DELETE FROM school WHERE id = #{school.id}")
